...
const TodaysProducts:React.FC<IToday> = ({image,description,ratings,numberSold,price,oldPrice}) =>{
    ...
    <div className={`bg-gray-300 h-[300px] px-8  w-[100%] mx-auto rounded-t-3xl`} style={{backgroundImage: `url('${image}')`, backgroundSize: "cover"}}>
      <FontAwesomeIcon icon={faHeart} className='tuser font-2xl relative p-3 w-5 h-5 bg-red-100 font-white-100 rounded-full left-90 mt-5'/> 
      </div>
