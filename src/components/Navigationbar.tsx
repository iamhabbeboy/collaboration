        ...
        <div className="navbar flex justify-between w-full mb-5 py-5" >
            ...
            <form action="\" className='mt-3'>
                <input type="text" className='inputText w-300 h-15 pl-25 rounded-lg capitalize text-2xl' name="" placeholder="find product on trade here" id="" />
                 <FontAwesomeIcon icon={faSearch} className='tuser text-grey-400 font-2xl relative text-2xl right-290'/>
            </form>
            <div className=''>
                <FontAwesomeIcon icon={faShoppingCart} className='tuser pr-9 pt-6 text-2xl text-gray-500'/>
                <FontAwesomeIcon icon={faBell} className='tuser text-grey-400 text-2xl text-gray-500'/>
            </div>
        </div>
    )
